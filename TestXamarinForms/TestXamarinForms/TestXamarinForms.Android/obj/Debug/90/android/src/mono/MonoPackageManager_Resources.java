...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "TestXamarinForms.Android.dll" comes first in this list. */
		"TestXamarinForms.Android.dll",
		"FormsViewGroup.dll",
		"Newtonsoft.Json.dll",
		...
		"OKHOSTING.Core.dll",
		"OKHOSTING.UI.dll",
		"OKHOSTING.UI.Xamarin.Android.dll",
		"OKHOSTING.UI.Xamarin.Forms.dll",
		"TestXamarinForms.dll",
		"TestXamarinForms.UI.dll",
